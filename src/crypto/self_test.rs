...
/// Message covered by both RSA KAT paths below.
const RSA_KAT_MESSAGE: &[u8] = b"FIPS POST RSA PKCS#1 v1.5 self-test";

// Fixed RSA-2048 / SHA-256 PKCS#1 v1.5 verification vector.
//
// Generated once with `examples/gen_rsa_kat.rs` on a build with
// `insecure-rustcrypto-rsa-private-ops` enabled, then checked in so the verify
// KAT needs no private-key operation at run time. The private key was
// discarded; only the public parameters and the signature are retained, so
// nothing secret is embedded here.
// modulus 256 bytes, exponent 3 bytes, signature 256 bytes
const RSA_KAT_MODULUS: &[u8] = &[
    ,
];
const RSA_KAT_PUBLIC_EXPONENT: &[u8] = &[0x01, 0x00, 0x01];
const RSA_KAT_SIGNATURE: &[u8] = &[
    ,
];

/// RSA PKCS#1 v1.5 known-answer test for RSA-2048 with SHA-256.
///
/// # Why this has two paths
///
/// Release builds refuse RustCrypto RSA **private-key** operations because the
/// `rsa` crate is subject to the Marvin timing attack (RUSTSEC-2023-0071); see
/// `require_rustcrypto_rsa_private_ops`. A KAT that unconditionally signs
/// therefore failed in every release build, which failed the POST, which failed
/// `C_Initialize`: the module could not start at all.
///
/// FIPS 140-3 requires a known-answer test for each approved security function
/// the module *provides*. When private-key operations are refused, RSA signature
/// generation is not a provided service and has no KAT to run; RSA signature
/// **verification** is still provided, and is covered here against a fixed
/// vector, including a negative case so that a verifier which accepts
...
/// Verify-only KAT against the fixed vector above.
///
